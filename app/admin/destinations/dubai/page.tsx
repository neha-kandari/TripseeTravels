...
const DubaiAdminPage = () => {
  ...
  const fetchPackages = async () => {
    try {
      ...
      console.log('API URL being called:', `/api/admin/packages?destination=dubai&t=${timestamp}`);
      ...
      if (response.ok) {
        ...
        console.log(`DUBAI PACKAGE FILTER: ${apiPackages.length} total packages, ${validPackages.length} valid packages`);
        
        const transformedPackages = validPackages.map((pkg: any) => {
          console.log('DUBAI PACKAGE TRANSFORM: Raw package:', pkg);
          console.log('DUBAI PACKAGE TRANSFORM: Package _id:', pkg._id);
          console.log('DUBAI PACKAGE TRANSFORM: Package id:', pkg.id);
          console.log('DUBAI PACKAGE TRANSFORM: Package hotelRating:', pkg.hotelRating);
          console.log('DUBAI PACKAGE TRANSFORM: Package days:', pkg.days);
          console.log('DUBAI PACKAGE TRANSFORM: Package type:', pkg.type);
  ...
  const handleDelete = async (id: string) => {
    ...
    try {
      console.log('Deleting Dubai package:', id);
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <Link
                        ...
                        onClick={() => {
                          console.log('Edit link clicked for package:', packageData.id, packageData.title);
                          console.log('Generated edit URL:', `/admin/destinations/dubai/packages/edit/${packageData.id}`);
                        }}
                      >
                        Edit
                      </Link>
